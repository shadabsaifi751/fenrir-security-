  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="md:bg-gray-50 dark:md:bg-[#161a21] sm:p-4 px-0 rounded-lg ">
        <div className="flex items-start flex-wrap gap-[25px] justify-start md:justify-between md:divide-x divide-gray-200 dark:divide-gray-800 md:border-0 border-b md:mb-0 mb-5 border-gray-200 dark:border-gray-800 pb-6 text-sm">
